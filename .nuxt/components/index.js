...
export { default as TopNavAlt } from '../../components/TopNavAlt.vue'
...
export const LazyTopNavAlt = import('../../components/TopNavAlt.vue' /* webpackChunkName: "components/top-nav-alt" */).then(c => wrapFunctional(c.default || c))
