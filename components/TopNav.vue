        ...
        <div class="container mx-auto px-6 py-3">
            <div class="flex items-center justify-between">
                <div class="hidden w-full text-gray-600 md:flex md:items-center">
                    ...
                    <span class="mx-1 text-lg">VN</span>
                </div>
            ...
            <div class="sm:flex sm:justify-center sm:items-center mt-4 rounded-xl border-2 py-4">
                <div class="flex flex-col justify-center items-center sm:flex-row">
                <a class="mt-3 text-white text-2xl font-bold hover:text-blue-600 sm:mx-3 sm:mt-0" href="#">Home</a>
                <a class="mt-3 text-white text-2xl font-bold hover:text-blue-600 sm:mx-3 sm:mt-0" href="#">Shop</a>
                <a class="mt-3 text-white text-2xl font-bold hover:text-blue-600 sm:mx-3 sm:mt-0" href="#">Categories</a>
                <a class="mt-3 text-white text-2xl font-bold hover:text-blue-600 sm:mx-3 sm:mt-0" href="#">Contact</a>
                <a class="mt-3 text-white text-2xl font-bold hover:text-blue-600 sm:mx-3 sm:mt-0" href="#">About</a>
                </div>
            </div>
        </div>
</template>